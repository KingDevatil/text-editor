...
export const lightTheme: Extension = EditorView.theme(
  {
    ...
    '.cm-gutters': { backgroundColor: '#f5f5f5', color: '#6e7681', borderRight: '1px solid #e0e0e0', fontFamily: '"JetBrains Mono", "Fira Code", "Consolas", monospace' },
...
export const darkTheme: Extension = EditorView.theme(
  {
    ...
    '.cm-gutters': { backgroundColor: '#252526', color: '#858585', borderRight: '1px solid #333333', fontFamily: '"JetBrains Mono", "Fira Code", "Consolas", monospace' },
